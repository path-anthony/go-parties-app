...
export const GUESTS: Record<OccasionId, string[]> = {
  kids: ["10-15", "15-20", "20-25", "25-30", "30-40", "40+"],
  adult: ["10-20", "20-30", "30-40", "40-60", "60-80", "80+"],
  wedding: ["50-75", "75-100", "100-125", "125-150", "150-200", "200+"],
  corporate: ["25-50", "50-100", "100-150", "150-250", "250-400", "400+"],
}
...
export const BUDGETS: Record<OccasionId, [label: string, ceiling: number][]> = {
  kids: [["Under $1,200", 1200], ["$1,200 to $2,000", 2000], ["$2,000 to $3,500", 3500], ["No ceiling", 99999]],
  adult: [["Under $2,500", 2500], ["$2,500 to $4,000", 4000], ["$4,000 to $6,000", 6000], ["No ceiling", 99999]],
  wedding: [["Under $6,000", 6000], ["$6,000 to $10,000", 10000], ["$10,000 to $15,000", 15000], ["$15,000 and up", 99999]],
  corporate: [["Under $6,000", 6000], ["$6,000 to $8,000", 8000], ["$8,000 to $12,000", 12000], ["$12,000 and up", 99999]],
}
